...
const UserInput = (props) => {
  ...
  return (
    <>
      <div className="user">
        <div className="user__input min-w-xs max-w-50 max-h-80 mx-auto p-4 mb-4">
          ...
          <form onSubmit={searchByRecipes} className="flex items-center mb-2">
            <div className="mr-2 flex-grow">
              <input
                type="text"
                id="input-text"
                className="w-full py-1 px-2 border border-solid border-gray-300 rounded focus:outline-none placeholder-gray-300 text-base"
                name="ingredients"
